...
libasound2-dev libsndfile1-dev libcjson-dev nodejs npm gedit libgnutls28-dev
...
cpio python3 python3-pip python3-pexpect xz-utils debianutils iputils-ping python3-git python3-jinja2 libsdl1.2-dev \
